...
public class MasterDataBiaya_RowRenderer extends DefaultTableCellRenderer implements TableCellRenderer{
        ...
        */
        switch(column){
            ...
            case 4:
                ...
                tc.setCellRenderer(this);
                tc.setPreferredWidth((int) Math.round(0.2*tableWidth) + 2);
                break;
            case 5:
                this.setHorizontalAlignment(CENTER);
                tc.setCellRenderer(this);
            ...
            case 6:
                this.setHorizontalAlignment(CENTER);
                tc.setCellRenderer(this);
                tc.setPreferredWidth((int) Math.round(0.049*tableWidth));
                break;
            case 7:
